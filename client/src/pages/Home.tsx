        ...
        <main className="overflow-hidden pt-24">
                ...
                <div className="mx-auto max-w-7xl pt-16 pb-20 sm:pt-24 sm:pb-28">
                    <div className="mx-auto max-w-4xl text-center">
                        ...
                        <p className="mx-auto mt-7 max-w-2xl text-base leading-7 text-muted-foreground sm:text-lg">
                            SeoRanker audits your website, tracks keywords and uses AI to tell you exactly what to improve next.
                        </p>
            ...
            <section id="features" className="px-4 py-24 sm:px-6 sm:py-32">
                <div className="mx-auto max-w-7xl">
                    <div className="max-w-2xl"><p className="eyebrow">Everything in one place</p><h2 className="section-title">The SEO workflow, <span className="gradient-text">simplified.</span></h2><p className="section-copy">From your first audit to daily ranking changes, SeoRanker brings the work into one focused workspace.</p></div>
            ...
            <section id="how-it-works" className="px-4 py-24 sm:px-6 sm:py-32">
                <div className="mx-auto max-w-7xl"><div className="text-center"><p className="eyebrow">How it works</p><h2 className="section-title">From URL to <span className="gradient-text">action plan.</span></h2><p className="section-copy mx-auto">A simple workflow designed to make SEO understandable and repeatable.</p></div><div className="mt-14 grid gap-4 md:grid-cols-3">{[['01','Analyze','Enter a URL and let SeoRanker inspect the page, structure and performance signals.'],['02','Understand','See the score, issues, keyword signals and AI explanations in one place.'],['03','Improve','Follow prioritized recommendations and track your progress over time.']].map(([n,t,d])=><div key={n} className="relative rounded-3xl border border-border bg-card p-7"><span className="text-5xl font-semibold tracking-tight text-accent/20">{n}</span><h3 className="mt-8 text-xl font-semibold">{t}</h3><p className="mt-2 text-sm leading-6 text-muted-foreground">{d}</p></div>)}</div></div>
            </section>
